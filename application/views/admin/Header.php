      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-ex1-collapse">
            ...
            <a class="navbar-brand" href="<?php echo base_url(); ?>admin">Courseroom Admin</a>
        </div>
 <?php 
...
<li <?php echo  $pg =='cms' ? 'class="active"' : '' ?>><a href="<?php echo base_url(); ?>admin/cms"><i class="fa fa-file"></i> CMS</a></li>     
 <li <?php echo  $pg =='course' ? 'class="active"' : '' ?>><a href="<?php echo base_url(); ?>admin/course"><i class="fa fa-file"></i> Courses</a></li>
          
            <li <?php echo  $pg =='user' ? 'class="active"' : '' ?>><a href="<?php echo base_url(); ?>admin/users"><i class="fa fa-file"></i> Student</a></li>
