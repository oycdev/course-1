...
<html>
    <head>
        ...
        <![endif]-->
        <style>
		.box{width:100%; float:left; margin-bottom:30px;}
		.box h2{text-align:center; padding:4px 0; font-size:32px; font-weight:bold;}
		.box  strong{text-align:center; padding:4px 0; font-size:24px; display:block; width:100%;}
		.box  span{text-align:center; padding:4px 0; font-size:20px; display:block; width:100%;}
		.search-inp-container{width:500px; margin:0px auto; padding-top:4px;}
        .search-inp-container .search-box{width:100%; padding:0px 0 0px 5px; float:left;}
		.search-inp-container .search-box input{border:none; padding:10px; color:#333; float:left; width:83.84%; background:#FFF; border-radius:4px 0 0px 4px;} 
		.search-inp-container .search-box .button{float:right; border:none; background:#09F; border-radius:0px 4px 4px 0px; float:right; padding:8px; color:#FFF; width:80px; font-size:16px; cursor:pointer;}
		.instructor{background: #09f none repeat scroll 0 0;
    border: medium none;
        ...
        <nav id="header" class="navbar navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Courseroom</a>
                </div>
                <div id="navbar" class="navbar-collapse collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="instructor"><a href="#" >Become an Instructor</a></li>
        ...
        <div class="home" id="home">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="box">
                    <h2>Courseroom</h2>
                   <strong>What course will your life take?</strong>
                   <span>Own your future by learning new skills online </span>
                        <div class="search-inp-container"><div class="search-box"><input name="" type="text" placeholder="Find a course on virtually anything"><input name="send" value="Search" type="button" class="button" ></div></div>
                        </div>
